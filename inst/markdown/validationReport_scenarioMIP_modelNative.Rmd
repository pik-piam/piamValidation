...
allReg <- readxl::read_xlsx(
  paste0(proj_dir, "/Code/scenarioMIP/validationByModel/common-definitions-template_2025-04-22.xlsx"),
  sheet = "region") %>%
...
mappings <- list.files(paste0(proj_dir,
                              "/Data/scenario_mip/ModelNative/regionmappings/"))
...
for (model in models) {
  ...
  hist_data_all <- rbind(hist_data_all, hist_data, hist_data_extra, hist_data_EV)
}
