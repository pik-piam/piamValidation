...
scen <- readRDS("data/REMIND_scenario_data_publication.rds")
hist <- readRDS("data/REMIND_reference_data_publication.rds")
data <- rbind(scen, hist)

df <- validateScenarios(data, "publication", extraColors = TRUE)
